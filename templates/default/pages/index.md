...
<div class="hero">
  ...
  <h2>Welcome to your new project! Edit&nbsp;<code style="font-size: 90%;">pages/index.md</code> to change this page.</h2>
...
<div class="grid grid-cols-4">
  ...
  <div class="card">
    Create a <a href="https://observablehq.com/framework/project-structure">new page</a> by adding a Markdown file (<code>whatever.md</code>) to the <code>pages</code> folder.
  </div>
  <div class="card">
