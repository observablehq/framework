...
describe("LoaderResolver.getSourceFileHash(path)", () => {
  it("returns the content hash for the specified file’s data loader", async () => {
    ...
    assert.strictEqual(loaders.getSourceFileHash("dynamic.zip"), "dcc1c22a59e1248f912688b38e3967ba965a01f9f9fc3d33914f06cad02c9cfc"); // prettier-ignore
    assert.strictEqual(loaders.getSourceFileHash("dynamic/file.txt"), "dcc1c22a59e1248f912688b38e3967ba965a01f9f9fc3d33914f06cad02c9cfc"); // prettier-ignore
    ...
    assert.strictEqual(loaders.getSourceFileHash("static/file.txt"), "4ca0382e2b282acc73e3f5fd4c58a61a4ab4e66eced4ae40c4866c6370f0e5ac"); // prettier-ignore
  });
