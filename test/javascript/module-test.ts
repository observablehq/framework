...
describe("getFileHash(root, path)", () => {
  ...
  it("returns the content hash for the specified file’s data loader", () => {
    assert.strictEqual(getFileHash("test/input/build/archives.posix", "dynamic.zip.sh"), "68223db0bf721258cce808d45ff5c77e0f14b35240d25940f40ed9cd1ad74fde"); // prettier-ignore
    assert.strictEqual(getFileHash("test/input/build/archives.posix", "dynamic.zip"), "68223db0bf721258cce808d45ff5c77e0f14b35240d25940f40ed9cd1ad74fde"); // prettier-ignore
    assert.strictEqual(getFileHash("test/input/build/archives.posix", "dynamic/file.txt"), "68223db0bf721258cce808d45ff5c77e0f14b35240d25940f40ed9cd1ad74fde"); // prettier-ignore
...
describe("getFileInfo(root, path)", () => {
  it("returns the info for the specified file", () => {
    ...
    assert.deepStrictEqual(redactFileInfo("test/input/build/archives.posix", "dynamic.zip.sh"), {hash: "68223db0bf721258cce808d45ff5c77e0f14b35240d25940f40ed9cd1ad74fde"}); // prettier-ignore
