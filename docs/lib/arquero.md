...
To load an Arquero table from an Apache Arrow, Apache Parquet, CSV, TSV, or JSON file, use [`FileAttachment.arquero`](../files#arquero) <a href="https://github.com/observablehq/framework/pull/1510" class="observablehq-version-badge" data-version="prerelease" title="Added in #1510"></a>:
