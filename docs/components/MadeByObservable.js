export function MadeByObservable() {
    return `
      ...
      <div>
          <div>
            ...
            <a class="section" href="/">
              ...
              The modern platform for developing and hosting powerful, performant,
              polyglot data apps built on open source
            </a>
            <a class="section" href="/">
          ...
          <div>
            ...
            <a class="section" href="/">
              ...
              A JavaScript library for visualizing tabular data, focused on
              accelerating exploratory data analysis
            </a>
            <a class="section" href="/">
              <h2>D3</h2>
              A JavaScript library for visualizing data, offering flexible,
              dynamic graphics with a low-level, web-standards based approach
            </a>
          </div>
      </div>
    </div>
