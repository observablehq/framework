...
<div class="tip">If you aren’t familiar with promises in JavaScript, we highly encourage you to read MDN’s <i><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Using_promises">Using promises</a></i> guide first.</div>
