...
export default {
  ...
  header: `<div style="height: 2.2rem; margin: -1.5rem -2rem 2rem -2rem; padding: 0.5rem 2rem; display: flex; align-items: center; justify-content: space-between; border-bottom: solid 1px var(--theme-foreground-faintest); font: 500 16px var(--sans-serif);">
  <label for="observablehq-sidebar-toggle" style="cursor: pointer; display: flex; gap: 0.5rem; align-items: center;">
