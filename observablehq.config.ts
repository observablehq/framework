export default {
  ...
  header: `<label for="observablehq-sidebar-toggle" style="cursor: pointer; height: 2.2rem; margin: -1.5rem -2rem 0 -2rem; padding: 0.5rem 2rem; display: flex; gap: 0.5rem; align-items: center; color: var(--theme-foreground-muted); border-bottom: solid 1px var(--theme-foreground-faintest); font: 500 16px var(--sans-serif);">
