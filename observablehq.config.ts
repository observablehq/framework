...
<script type="module">/Win/.test(navigator.platform) || Array.from(document.querySelectorAll(".win"), (e) => e.remove())</script>`,
  ...
  header: `<div style="display: flex; flex-grow: 1; justify-content: space-between; align-items: baseline;">
    <div>
      <a href="/" class="hide-if-sidebar" style="display: flex; align-items: baseline; gap: 0.25rem;">
